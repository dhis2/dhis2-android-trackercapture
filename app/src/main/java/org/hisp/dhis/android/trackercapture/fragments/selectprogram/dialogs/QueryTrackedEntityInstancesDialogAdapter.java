...
public class QueryTrackedEntityInstancesDialogAdapter extends BaseAdapter implements Filterable {
    /**
    ...
    public QueryTrackedEntityInstancesDialogAdapter(LayoutInflater inflater) {
        mInflater = inflater;
